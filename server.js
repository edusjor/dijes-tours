...
const PAYMENT_IBAN_LEGACY = process.env.PAYMENT_IBAN || '';
const PAYMENT_IBAN_CRC = process.env.PAYMENT_IBAN_CRC || PAYMENT_IBAN_LEGACY || 'CR23015108410026012345';
const PAYMENT_IBAN_USD = process.env.PAYMENT_IBAN_USD || PAYMENT_IBAN_LEGACY || PAYMENT_IBAN_CRC;
